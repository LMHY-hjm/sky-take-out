...
//        }
        ...
        //直接跳过调用微信支付接口，直接判定为支付完成（仅包含下两行代码）
...
//            log.info("申请退款：{}", refund);
            ...
            //以下语句原先在if语句外，但由于跳过了微信支付功能，因此将其放入if语句中，防止出错
    ...
    public void cancel(OrdersCancelDTO ordersCancelDTO) throws Exception {
        ...
        //以下判断注释原因，跳过了微信支付，不存在点击了支付但是没付款的步骤，不需要给用户退款，因此可以跳过
//        if (payStatus == 1) {
//            //用户已支付，需要退款
////            String refund = weChatPayUtil.refund(
////                    ordersDB.getNumber(),
